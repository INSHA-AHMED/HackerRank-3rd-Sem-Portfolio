...
This repository contains my HackerRank algorithmic problem-solving portfolio for the 3rd semester.

The portfolio demonstrates my understanding of fundamental data structures, arrays, strings, dynamic memory allocation, and algorithmic problem solving using the C programming language.
...
|---|---|---|---|---|
| 1 | Diagonal Difference | 2D Arrays / Matrices | O(N²) | O(N²) |
| 2 | Dynamic Array | Dynamic Arrays | O(Q) average | O(N + Q) |
| 3 | Time Conversion | Strings / Logic | O(1) | O(1) |
| 4 | Compare the Triplets | Arrays / Basic Logic | O(1) | O(1) |
| 5 | Sparse Arrays | Strings / Searching | O(N × Q) | O(N) |
